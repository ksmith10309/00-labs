...
function displayPics(){
  ...
  // Variables declared by let have their scope in the block for which they are defined, as well as in any contained sub-blocks. Since the variable declaration of rando was inside of a while loop, if let is used, it will have its scope remain inside of the while loop.
  console.log(viewed);
